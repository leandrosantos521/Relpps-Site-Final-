...
- `PUBLIC_SITE_URL=https://relpps.com.br`
...
`https://relpps.com.br/.netlify/functions/checkout?action=infinitepay-webhook`
...
Abra `https://relpps.com.br/api/health`.
...
3. Abra `https://relpps.com.br/homologacao-bling.html`.
