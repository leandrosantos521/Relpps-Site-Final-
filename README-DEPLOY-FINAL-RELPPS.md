...
Domínio configurado: `https://relppscosmetic.netlify.app`
...
3. No aplicativo do Bling, o callback deve ser exatamente `https://relppscosmetic.netlify.app/bling-callback.html`.
4. Abra `https://relppscosmetic.netlify.app/api/health` para verificar o preflight.
