...
`https://relppscosmetico.netlify.app/.netlify/functions/checkout?action=infinitepay-webhook`
...
Abra `https://relppscosmetico.netlify.app/api/health`.
...
3. Abra `https://relppscosmetico.netlify.app/homologacao-bling.html`.
