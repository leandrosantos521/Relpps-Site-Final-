...
Domínio configurado: `https://relppscosmetico.netlify.app`
...
3. No aplicativo do Bling, o callback deve ser exatamente `https://relppscosmetico.netlify.app/bling-callback.html`.
4. Abra `https://relppscosmetico.netlify.app/api/health` para verificar o preflight.
