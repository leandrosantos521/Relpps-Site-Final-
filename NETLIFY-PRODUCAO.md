...
`https://relppscosmetic.netlify.app/.netlify/functions/checkout?action=infinitepay-webhook`
...
Abra `https://relppscosmetic.netlify.app/api/health`.
...
3. Abra `https://relppscosmetic.netlify.app/homologacao-bling.html`.
